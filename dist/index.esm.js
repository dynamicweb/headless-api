...
function $29b57722f486c5a3$export$de0c4a986b439e52(message, status, response, headers, result) {
    if (result !== null && result !== undefined) throw result;
    else throw new $29b57722f486c5a3$export$96fc0f3bebede439(message, status, response, headers, null);
}
class $29b57722f486c5a3$export$96fc0f3bebede439 extends Error {
...
class $535395604a0839db$export$a66da012ed2ad4db {
    constructor(data){
        if (data) {
    ...
    static fromJS(data) {
        ...
        let result = new $535395604a0839db$export$a66da012ed2ad4db();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $01fa9bc5f740e732$export$86cdebf7c744b08f {
    constructor(data){
        if (data) {
            for(var property in data)if (data.hasOwnProperty(property)) this[property] = data[property];
        }
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $01fa9bc5f740e732$export$86cdebf7c744b08f();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $da113e3412d10fe0$export$9081fc5a5abbafb5 {
    constructor(data){
        if (data) {
            for(var property in data)if (data.hasOwnProperty(property)) this[property] = data[property];
        }
...
class $da113e3412d10fe0$export$56d724b3d6ab4309 extends $da113e3412d10fe0$export$9081fc5a5abbafb5 {
    constructor(data){
        super(data);
    }
    init(_data) {
...
class $5cfc5f8ccdb530db$export$476ba50ca24afb42 {
    constructor(data){
        if (data) {
            for(var property in data)if (data.hasOwnProperty(property)) this[property] = data[property];
        }
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $5cfc5f8ccdb530db$export$476ba50ca24afb42();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $de1054c86e43fcea$export$e1bb774e9664e700 {
    constructor(data){
        if (data) {
            for(var property in data)if (data.hasOwnProperty(property)) this[property] = data[property];
        }
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $de1054c86e43fcea$export$e1bb774e9664e700();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
let $de1054c86e43fcea$export$4624c240901a6889;
(function(Types1) {
    Types1["Text"] = "Text";
...
})($de1054c86e43fcea$export$4624c240901a6889 || ($de1054c86e43fcea$export$4624c240901a6889 = {}));


class $62369b1ec6c9684f$export$91675e6589fc4da7 extends (0, $de1054c86e43fcea$export$e1bb774e9664e700) {
    constructor(data){
        super(data);
    }
    init(_data) {
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $62369b1ec6c9684f$export$91675e6589fc4da7();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $fd394e97b170d951$export$e949d48bc8e11763 extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            this.name = _data["Name"];
            this.options = _data["Options"] ? (0, $62369b1ec6c9684f$export$91675e6589fc4da7).fromJS(_data["Options"]) : undefined;
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $fd394e97b170d951$export$e949d48bc8e11763();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $111fe12c7702cc1b$export$88f615852494efb2 extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            this.address = _data["Address"];
            this.address2 = _data["Address2"];
            this.location = _data["Location"] ? (0, $5cfc5f8ccdb530db$export$476ba50ca24afb42).fromJS(_data["Location"]) : undefined;
            this.city = _data["City"];
            this.company = _data["Company"];
            ...
            if (_data["CustomFields"]) {
                this.customFields = {};
                for(let key in _data["CustomFields"])if (_data["CustomFields"].hasOwnProperty(key)) this.customFields[key] = _data["CustomFields"][key] ? (0, $fd394e97b170d951$export$e949d48bc8e11763).fromJS(_data["CustomFields"][key]) : new (0, $fd394e97b170d951$export$e949d48bc8e11763)();
            }
            if (_data["AddressCustomFields"]) {
                this.addressCustomFields = {};
                for(let key in _data["AddressCustomFields"])if (_data["AddressCustomFields"].hasOwnProperty(key)) this.addressCustomFields[key] = _data["AddressCustomFields"][key] ? (0, $fd394e97b170d951$export$e949d48bc8e11763).fromJS(_data["AddressCustomFields"][key]) : new (0, $fd394e97b170d951$export$e949d48bc8e11763)();
            }
        }
    }
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $111fe12c7702cc1b$export$88f615852494efb2();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $01683bbd8995abc5$export$e3378d92d7ea84e extends (0, $ec0f87cb64500431$export$8f6e4be34af2779b) {
    ...
    processAuthenticate(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            result200 = (0, $535395604a0839db$export$a66da012ed2ad4db).fromJS(resultData200);
            return result200;
        });
        else if (status === 404) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("Username or password is not valid", status, _responseText, _headers);
        });
        else if (status === 403) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("Unable to create JWT for user", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
    ...
    processRefresh(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("Token could not be authorized\nor\nToken expired", status, _responseText, _headers);
        });
        else if (status === 400) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("Something is wrong with the JWT string", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
    ...
    processResetpassword(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("The user is not found.", status, _responseText, _headers);
        });
        else if (status === 400) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("Password not accepted: {reason}", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
    ...
    processGetAddresses(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            let result200 = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = (0, $01fa9bc5f740e732$export$86cdebf7c744b08f).fromJS(resultData200);
            return result200;
        });
        else if (status === 404) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("The user is not found.", status, _responseText, _headers);
    ...
    processGetUserInfo(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            let result200 = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = (0, $111fe12c7702cc1b$export$88f615852494efb2).fromJS(resultData200);
            return result200;
        });
        else if (status === 403) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("The user could not be saved. Username or email has to be specified. If username is specified, it has to be unique. Password requirements must be met.", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
...
var $c04bd6215bd9ff9b$export$2e2bcd8739ae039 = {
    UsersClient: $01683bbd8995abc5$export$e3378d92d7ea84e
};
...
class $3e7765347040932f$export$c78ffd8783cb7b2c extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $3e7765347040932f$export$c78ffd8783cb7b2c();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $e54c71f3bcc5f3da$export$9bebe57d18a7d1f6 extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            this.firstActivePage = _data["FirstActivePage"] ? (0, $3e7765347040932f$export$c78ffd8783cb7b2c).fromJS(_data["FirstActivePage"]) : undefined;
            this.firstPage = _data["FirstPage"] ? (0, $3e7765347040932f$export$c78ffd8783cb7b2c).fromJS(_data["FirstPage"]) : undefined;
            this.iD = _data["ID"];
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $e54c71f3bcc5f3da$export$9bebe57d18a7d1f6();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $7ee0eefe5962f990$export$be87d9e401b80f33 extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $7ee0eefe5962f990$export$be87d9e401b80f33();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $6650ff03c7b5c1fa$export$7edd97445626b06b extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            if (Array.isArray(_data["Fields"])) {
                this.fields = [];
                for (let item of _data["Fields"])this.fields.push((0, $7ee0eefe5962f990$export$be87d9e401b80f33).fromJS(item));
            }
            this.id = _data["Id"];
            this.systemName = _data["SystemName"];
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $6650ff03c7b5c1fa$export$7edd97445626b06b();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $a69addafe5c8db74$export$5d48c2587cd93482 extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            this.item = _data["Item"] ? (0, $6650ff03c7b5c1fa$export$7edd97445626b06b).fromJS(_data["Item"]) : undefined;
            if (Array.isArray(_data["Languages"])) {
                this.languages = [];
                for (let item of _data["Languages"])this.languages.push((0, $e54c71f3bcc5f3da$export$9bebe57d18a7d1f6).fromJS(item));
            }
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $a69addafe5c8db74$export$5d48c2587cd93482();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $65782a69baa2c12f$export$df76c3bacd435747 extends (0, $ec0f87cb64500431$export$8f6e4be34af2779b) {
    ...
    processGetAll(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            if (Array.isArray(resultData200)) {
                result200 = [];
                for (let item of resultData200)result200.push((0, $a69addafe5c8db74$export$5d48c2587cd93482).fromJS(item));
            } else result200 = null;
            return result200;
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
    ...
    processGetById(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            let result200 = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = (0, $a69addafe5c8db74$export$5d48c2587cd93482).fromJS(resultData200);
            return result200;
        });
        else if (status === 404) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("Not found\nor\nThe area is not published.", status, _responseText, _headers);
        });
        else if (status === 403) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("The current user does not have the needed permissions to view the area.", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
    ...
    processGetByDomain(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("No areas found for the given domain", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
...
class $370ee4d46200c4b6$export$aaa95e14a6481fff {
    constructor(data){
        if (data) {
            for(var property in data)if (data.hasOwnProperty(property)) this[property] = data[property];
        }
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $370ee4d46200c4b6$export$aaa95e14a6481fff();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $7b57ad9fc7948799$export$cf52083a8935362b extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $7b57ad9fc7948799$export$cf52083a8935362b();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $276d91df116c249f$export$7e303fa979f8a332 extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            this.paragraphId = _data["ParagraphId"];
            this.paragraph = _data["Paragraph"] ? (0, $7b57ad9fc7948799$export$cf52083a8935362b).fromJS(_data["Paragraph"]) : undefined;
        }
    }
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $276d91df116c249f$export$7e303fa979f8a332();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $1a430d75587022ee$export$f63e98f49938fb87 extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            this.id = _data["Id"];
            this.definition = _data["Definition"] ? (0, $370ee4d46200c4b6$export$aaa95e14a6481fff).fromJS(_data["Definition"]) : undefined;
            if (Array.isArray(_data["Columns"])) {
                this.columns = [];
                for (let item of _data["Columns"])this.columns.push((0, $276d91df116c249f$export$7e303fa979f8a332).fromJS(item));
            }
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $1a430d75587022ee$export$f63e98f49938fb87();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $9887afbc95c9e534$export$f847c61fd47190b3 extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["Nodes"])) {
                this.nodes = [];
                for (let item of _data["Nodes"])this.nodes.push($9887afbc95c9e534$export$f847c61fd47190b3.fromJS(item));
            }
        }
    }
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $9887afbc95c9e534$export$f847c61fd47190b3();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $53b8b93422e4d3b9$export$d7f927033ffdf23f extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            if (Array.isArray(_data["Nodes"])) {
                this.nodes = [];
                for (let item of _data["Nodes"])this.nodes.push((0, $9887afbc95c9e534$export$f847c61fd47190b3).fromJS(item));
            }
            if (_data["Parameters"]) {
                this.parameters = {};
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $53b8b93422e4d3b9$export$d7f927033ffdf23f();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $2a1a6d49ddc31407$export$4b77aa913f68641f extends (0, $ec0f87cb64500431$export$8f6e4be34af2779b) {
    ...
    processGetById(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            let result200 = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = (0, $53b8b93422e4d3b9$export$d7f927033ffdf23f).fromJS(resultData200);
            return result200;
        });
        else if (status === 404) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("Not found\nor\nThe page is not published.\nor\nThe area is not published.", status, _responseText, _headers);
...
let $2a1a6d49ddc31407$export$58103b785ab8fcf8;
(function(ExpandMode1) {
    ExpandMode1["None"] = "None";
    ExpandMode1["All"] = "All";
    ExpandMode1["Path"] = "Path";
    ExpandMode1["PathOnly"] = "PathOnly";
})($2a1a6d49ddc31407$export$58103b785ab8fcf8 || ($2a1a6d49ddc31407$export$58103b785ab8fcf8 = {}));
...
class $6fb41d92395cc6d9$export$18ddf593de07da32 extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            this.isCurrent = _data["IsCurrent"];
            this.isMaster = _data["IsMaster"];
            this.page = _data["Page"] ? (0, $3e7765347040932f$export$c78ffd8783cb7b2c).fromJS(_data["Page"]) : undefined;
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $6fb41d92395cc6d9$export$18ddf593de07da32();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $ac6718b9be52d116$export$4ce9f6c7bfdcec1b extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["Path"])) {
                this.path = [];
                for (let item of _data["Path"])this.path.push((0, $3e7765347040932f$export$c78ffd8783cb7b2c).fromJS(item));
            }
            if (Array.isArray(_data["Languages"])) {
                this.languages = [];
                for (let item of _data["Languages"])this.languages.push((0, $6fb41d92395cc6d9$export$18ddf593de07da32).fromJS(item));
            }
            this.item = _data["Item"] ? (0, $6650ff03c7b5c1fa$export$7edd97445626b06b).fromJS(_data["Item"]) : undefined;
            this.propertyItem = _data["PropertyItem"] ? (0, $6650ff03c7b5c1fa$export$7edd97445626b06b).fromJS(_data["PropertyItem"]) : undefined;
        }
    }
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $ac6718b9be52d116$export$4ce9f6c7bfdcec1b();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $fb48a0a37d7d0276$export$427a4a73e42a637a extends (0, $ec0f87cb64500431$export$8f6e4be34af2779b) {
    ...
    processGetAll(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            if (Array.isArray(resultData200)) {
                result200 = [];
                for (let item of resultData200)result200.push((0, $ac6718b9be52d116$export$4ce9f6c7bfdcec1b).fromJS(item));
            } else result200 = null;
            return result200;
        });
        else if (status === 404) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("The area is not found.\nor\nThe area is not published.\nor\nThe query returned no pages.", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
    ...
    processGetById(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            let result200 = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = (0, $ac6718b9be52d116$export$4ce9f6c7bfdcec1b).fromJS(resultData200);
            return result200;
        });
        else if (status === 404) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("Not found.\nor\nThe page is not published.\nor\nThe area is not published.", status, _responseText, _headers);
...
class $b4e22f85ea73bda9$export$493d4972488c639c extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
        super.init(_data);
        if (_data) {
            this.cartPage = _data["CartPage"] ? (0, $3e7765347040932f$export$c78ffd8783cb7b2c).fromJS(_data["CartPage"]) : undefined;
            this.createdDate = _data["CreatedDate"] ? new Date(_data["CreatedDate"].toString()) : undefined;
            ...
            this.name = _data["Name"];
            this.searchPage = _data["SearchPage"] ? (0, $3e7765347040932f$export$c78ffd8783cb7b2c).fromJS(_data["SearchPage"]) : undefined;
            this.updatedDate = _data["UpdatedDate"] ? new Date(_data["UpdatedDate"].toString()) : undefined;
        }
    }
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $b4e22f85ea73bda9$export$493d4972488c639c();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $71ba1e0d46c81a30$export$d9c3b87812883495 {
    constructor(data){
        if (data) {
            for(var property in data)if (data.hasOwnProperty(property)) this[property] = data[property];
        }
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $71ba1e0d46c81a30$export$d9c3b87812883495();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $6fb759349048426e$export$f90500b8ef904c9f {
    constructor(data){
        if (data) {
            for(var property in data)if (data.hasOwnProperty(property)) this[property] = data[property];
        }
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $6fb759349048426e$export$f90500b8ef904c9f();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $f19c335b2fc44d05$export$1c8dced55726649b {
    constructor(data){
        if (data) {
            for(var property in data)if (data.hasOwnProperty(property)) this[property] = data[property];
        }
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $f19c335b2fc44d05$export$1c8dced55726649b();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $32c6f692d4eea8f1$export$f7966fe22473d337 {
    constructor(data){
        if (data) {
            for(var property in data)if (data.hasOwnProperty(property)) this[property] = data[property];
        }
    ...
    init(_data) {
        if (_data) {
            this.price = _data["Price"] ? (0, $71ba1e0d46c81a30$export$d9c3b87812883495).fromJS(_data["Price"]) : undefined;
            this.priceWithVat = _data["PriceWithVat"] ? (0, $71ba1e0d46c81a30$export$d9c3b87812883495).fromJS(_data["PriceWithVat"]) : undefined;
            this.priceWithoutVat = _data["PriceWithoutVat"] ? (0, $71ba1e0d46c81a30$export$d9c3b87812883495).fromJS(_data["PriceWithoutVat"]) : undefined;
            this.vat = _data["Vat"] ? (0, $71ba1e0d46c81a30$export$d9c3b87812883495).fromJS(_data["Vat"]) : undefined;
            this.vatPercent = _data["VatPercent"] ? (0, $6fb759349048426e$export$f90500b8ef904c9f).fromJS(_data["VatPercent"]) : undefined;
            this.currency = _data["Currency"] ? (0, $f19c335b2fc44d05$export$1c8dced55726649b).fromJS(_data["Currency"]) : undefined;
        }
    }
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $32c6f692d4eea8f1$export$f7966fe22473d337();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $aef9076c1b2580b1$export$12f8875581f71705 extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["CartOrderlines"])) {
                this.cartOrderlines = [];
                for (let item of _data["CartOrderlines"])this.cartOrderlines.push($aef9076c1b2580b1$export$c243f24fb0bd73d8.fromJS(item));
            }
            this.totalPrice = _data["TotalPrice"] ? (0, $32c6f692d4eea8f1$export$f7966fe22473d337).fromJS(_data["TotalPrice"]) : undefined;
            this.totalDiscount = _data["TotalDiscount"] ? (0, $32c6f692d4eea8f1$export$f7966fe22473d337).fromJS(_data["TotalDiscount"]) : undefined;
            this.totalPriceWithoutDiscounts = _data["TotalPriceWithoutDiscounts"] ? (0, $32c6f692d4eea8f1$export$f7966fe22473d337).fromJS(_data["TotalPriceWithoutDiscounts"]) : undefined;
            this.totalPriceWithoutFees = _data["TotalPriceWithoutFees"] ? (0, $32c6f692d4eea8f1$export$f7966fe22473d337).fromJS(_data["TotalPriceWithoutFees"]) : undefined;
            this.paymentMethod = _data["PaymentMethod"];
            this.paymentFee = _data["PaymentFee"] ? (0, $32c6f692d4eea8f1$export$f7966fe22473d337).fromJS(_data["PaymentFee"]) : undefined;
            this.shippingMethod = _data["ShippingMethod"];
            this.shippingFee = _data["ShippingFee"] ? (0, $32c6f692d4eea8f1$export$f7966fe22473d337).fromJS(_data["ShippingFee"]) : undefined;
            this.isEmpty = _data["IsEmpty"];
        }
    }
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $aef9076c1b2580b1$export$12f8875581f71705();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $aef9076c1b2580b1$export$c243f24fb0bd73d8 extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            this.unitPrice = _data["UnitPrice"] ? (0, $32c6f692d4eea8f1$export$f7966fe22473d337).fromJS(_data["UnitPrice"]) : undefined;
            this.unitPriceBeforeDiscount = _data["UnitPriceBeforeDiscount"] ? (0, $32c6f692d4eea8f1$export$f7966fe22473d337).fromJS(_data["UnitPriceBeforeDiscount"]) : undefined;
            this.totalPrice = _data["TotalPrice"] ? (0, $32c6f692d4eea8f1$export$f7966fe22473d337).fromJS(_data["TotalPrice"]) : undefined;
            this.totalDiscount = _data["TotalDiscount"] ? (0, $32c6f692d4eea8f1$export$f7966fe22473d337).fromJS(_data["TotalDiscount"]) : undefined;
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $aef9076c1b2580b1$export$c243f24fb0bd73d8();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $ac715dc3c47cc4d4$export$e288868a4b2c3c3 extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
        super.init(_data);
        if (_data) {
            this.area = _data["Area"] ? (0, $b4e22f85ea73bda9$export$493d4972488c639c).fromJS(_data["Area"]) : undefined;
            this.createdDate = _data["CreatedDate"] ? new Date(_data["CreatedDate"].toString()) : undefined;
            this.currentSecondaryUser = _data["CurrentSecondaryUser"] ? (0, $111fe12c7702cc1b$export$88f615852494efb2).fromJS(_data["CurrentSecondaryUser"]) : undefined;
            this.currentUser = _data["CurrentUser"] ? (0, $111fe12c7702cc1b$export$88f615852494efb2).fromJS(_data["CurrentUser"]) : undefined;
            this.isCurrentUserAllowed = _data["IsCurrentUserAllowed"];
            this.cart = _data["Cart"] ? (0, $aef9076c1b2580b1$export$12f8875581f71705).fromJS(_data["Cart"]) : undefined;
            if (_data["Content"]) {
                this.content = {};
            ...
            this.title = _data["Title"];
            this.topPage = _data["TopPage"] ? (0, $3e7765347040932f$export$c78ffd8783cb7b2c).fromJS(_data["TopPage"]) : undefined;
            this.updatedDate = _data["UpdatedDate"] ? new Date(_data["UpdatedDate"].toString()) : undefined;
            if (Array.isArray(_data["SecondaryUsers"])) {
                this.secondaryUsers = [];
                for (let item of _data["SecondaryUsers"])this.secondaryUsers.push((0, $111fe12c7702cc1b$export$88f615852494efb2).fromJS(item));
            }
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $ac715dc3c47cc4d4$export$e288868a4b2c3c3();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $640f8b4c719afd5b$export$8625a278c3202ff9 extends (0, $ec0f87cb64500431$export$8f6e4be34af2779b) {
    ...
    processGetById(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            let result200 = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = (0, $ac715dc3c47cc4d4$export$e288868a4b2c3c3).fromJS(resultData200);
            return result200;
        });
        else if (status === 404) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("Not found\nor\nThe page is not published.\nor\nThe area is not published.", status, _responseText, _headers);
...
class $7692e55b428d17c4$export$5b316b7b8ac649a8 extends (0, $ec0f87cb64500431$export$8f6e4be34af2779b) {
    ...
    processGetAll(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("The page is not published.\nor\nThe area is not published.", status, _responseText, _headers);
        });
        else if (status === 403) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("Page is password protected and cannot be accessed using this endpoint.\nor\nThe current user does not have the needed permissions to view the page.\nor\nThe current user does not have the needed permissions to view the area.", status, _responseText, _headers);
        });
    ...
    processGetById(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            let result200 = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = (0, $7b57ad9fc7948799$export$cf52083a8935362b).fromJS(resultData200);
            return result200;
        });
        else if (status === 404) return response.text().then((_responseText)=>{
...
class $1f53c375e50b96f3$export$f290bb1bb2a6eae1 {
    constructor(data){
        if (data) {
            for(var property in data)if (data.hasOwnProperty(property)) this[property] = data[property];
        }
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $1f53c375e50b96f3$export$f290bb1bb2a6eae1();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $1f53c375e50b96f3$export$cd0f44441c3b7719 {
    constructor(data){
        if (data) {
            for(var property in data)if (data.hasOwnProperty(property)) this[property] = data[property];
        }
    ...
    init(_data) {
        if (_data) {
            ...
            this.defaultValue = _data["DefaultValue"];
            this.translations = _data["Translations"] ? $1f53c375e50b96f3$export$c7d6e25184a84001.fromJS(_data["Translations"]) : undefined;
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $1f53c375e50b96f3$export$cd0f44441c3b7719();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
let $1f53c375e50b96f3$export$a0295b5f8707aed7;
(function(KeyScope1) {
...
})($1f53c375e50b96f3$export$a0295b5f8707aed7 || ($1f53c375e50b96f3$export$a0295b5f8707aed7 = {}));
class $1f53c375e50b96f3$export$c7d6e25184a84001 {
    constructor(data){
        if (data) {
            for(var property in data)if (data.hasOwnProperty(property)) this[property] = data[property];
        }
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $1f53c375e50b96f3$export$c7d6e25184a84001();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $1f53c375e50b96f3$export$8ab6ae76ba4fc0ef {
    constructor(data){
        if (data) {
            for(var property in data)if (data.hasOwnProperty(property)) this[property] = data[property];
        }
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $1f53c375e50b96f3$export$8ab6ae76ba4fc0ef();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $1f53c375e50b96f3$export$b63289fbda65eed1 {
    constructor(data){
        if (data) {
            for(var property in data)if (data.hasOwnProperty(property)) this[property] = data[property];
        }
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $1f53c375e50b96f3$export$b63289fbda65eed1();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $ee34bd2ff5f945ee$export$9e45ef366e845f2f extends (0, $ec0f87cb64500431$export$8f6e4be34af2779b) {
    ...
    processGetAll(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            let result200 = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = (0, $1f53c375e50b96f3$export$f290bb1bb2a6eae1).fromJS(resultData200);
            return result200;
        });
        else if (status === 404) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("The specified area was not found\nor\nLayout not specified on area", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
    ...
    processGetAll2(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("The specified design was not found", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
    ...
    processGetAllAll(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            if (Array.isArray(resultData200)) {
                result200 = [];
                for (let item of resultData200)result200.push((0, $1f53c375e50b96f3$export$b63289fbda65eed1).fromJS(item));
            } else result200 = null;
            return result200;
        });
        else if (status === 404) return response.text().then((_responseText)=>{
...
var $e3157da9779f0eea$export$2e2bcd8739ae039 = {
    AreasClient: $65782a69baa2c12f$export$df76c3bacd435747,
    GridRowClient: $0b8922466999951b$export$5cfee608d429befb,
    NavigationsClient: $2a1a6d49ddc31407$export$4b77aa913f68641f,
    PagesClient: $fb48a0a37d7d0276$export$427a4a73e42a637a,
    PageViewsClient: $640f8b4c719afd5b$export$8625a278c3202ff9,
    ParagraphsClient: $7692e55b428d17c4$export$5b316b7b8ac649a8,
    TranslationsClient: $ee34bd2ff5f945ee$export$9e45ef366e845f2f
};
...
class $a0c5af3f7cf64f44$export$4fa50a4986ae6cc1 extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $a0c5af3f7cf64f44$export$4fa50a4986ae6cc1();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $a0c5af3f7cf64f44$export$23e546e5a70ef637 extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $a0c5af3f7cf64f44$export$23e546e5a70ef637();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $4d62a84edb048ac1$export$314c028c62371730 extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $4d62a84edb048ac1$export$314c028c62371730();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $82fdad90cef4c12d$export$721ac1d6252bcdb extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $82fdad90cef4c12d$export$721ac1d6252bcdb();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $8bd465f6b80748fc$export$8d3c15329cf77c26 extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $8bd465f6b80748fc$export$8d3c15329cf77c26();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $cdca1f42c0609789$export$eed10c966122c057 extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $cdca1f42c0609789$export$eed10c966122c057();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $ca99af87b96f49d8$export$6f32a34769e7c3bf extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["OrderLines"])) {
                this.orderLines = [];
                for (let item of _data["OrderLines"])this.orderLines.push($ca99af87b96f49d8$export$8894df4b1b22f35e.fromJS(item));
            }
            if (_data["OrderFields"]) {
                this.orderFields = {};
                for(let key in _data["OrderFields"])if (_data["OrderFields"].hasOwnProperty(key)) this.orderFields[key] = _data["OrderFields"][key] ? (0, $a0c5af3f7cf64f44$export$4fa50a4986ae6cc1).fromJS(_data["OrderFields"][key]) : new (0, $a0c5af3f7cf64f44$export$4fa50a4986ae6cc1)();
            }
            this.totalDiscount = _data["TotalDiscount"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["TotalDiscount"]) : undefined;
            this.totalProductDiscount = _data["TotalProductDiscount"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["TotalProductDiscount"]) : undefined;
            this.totalOrderDiscount = _data["TotalOrderDiscount"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["TotalOrderDiscount"]) : undefined;
            this.price = _data["Price"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["Price"]) : undefined;
            this.priceBeforeFees = _data["PriceBeforeFees"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["PriceBeforeFees"]) : undefined;
            this.totalPriceBeforeFeesAndTaxes = _data["TotalPriceBeforeFeesAndTaxes"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["TotalPriceBeforeFeesAndTaxes"]) : undefined;
            this.totalTaxes = _data["TotalTaxes"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["TotalTaxes"]) : undefined;
            this.shippingFee = _data["ShippingFee"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["ShippingFee"]) : undefined;
            this.shippingMethod = _data["ShippingMethod"] ? (0, $cdca1f42c0609789$export$eed10c966122c057).fromJS(_data["ShippingMethod"]) : undefined;
            this.paymentMethod = _data["PaymentMethod"] ? (0, $82fdad90cef4c12d$export$721ac1d6252bcdb).fromJS(_data["PaymentMethod"]) : undefined;
            this.paymentFee = _data["PaymentFee"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["PaymentFee"]) : undefined;
        }
    }
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $ca99af87b96f49d8$export$6f32a34769e7c3bf();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $ca99af87b96f49d8$export$8894df4b1b22f35e extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            this.productImage = _data["ProductImage"];
            this.primaryOrDefaultGroup = _data["PrimaryOrDefaultGroup"] ? (0, $4d62a84edb048ac1$export$314c028c62371730).fromJS(_data["PrimaryOrDefaultGroup"]) : undefined;
            this.reference = _data["Reference"];
            this.quantity = _data["Quantity"];
            this.weight = _data["Weight"];
            this.volume = _data["Volume"];
            ...
            if (_data["OrderLineFields"]) {
                ...
                for(let key in _data["OrderLineFields"])if (_data["OrderLineFields"].hasOwnProperty(key)) this.orderLineFields[key] = _data["OrderLineFields"][key] ? (0, $a0c5af3f7cf64f44$export$4fa50a4986ae6cc1).fromJS(_data["OrderLineFields"][key]) : new (0, $a0c5af3f7cf64f44$export$4fa50a4986ae6cc1)();
            }
            this.price = _data["Price"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["Price"]) : undefined;
            this.unitPrice = _data["UnitPrice"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["UnitPrice"]) : undefined;
            this.unitPriceBeforeDiscount = _data["UnitPriceBeforeDiscount"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["UnitPriceBeforeDiscount"]) : undefined;
            this.totalDiscount = _data["TotalDiscount"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["TotalDiscount"]) : undefined;
            if (Array.isArray(_data["BomOrderLines"])) {
                this.bomOrderLines = [];
                for (let item of _data["BomOrderLines"])this.bomOrderLines.push($ca99af87b96f49d8$export$8894df4b1b22f35e.fromJS(item));
            }
        }
    }
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $ca99af87b96f49d8$export$8894df4b1b22f35e();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
let $ca99af87b96f49d8$export$ebabf1f6e8484fd8;
...
})($ca99af87b96f49d8$export$ebabf1f6e8484fd8 || ($ca99af87b96f49d8$export$ebabf1f6e8484fd8 = {}));


class $6ca33ce44c416691$export$851d109e5e4aef3d {
    constructor(data){
        if (data) {
            for(var property in data)if (data.hasOwnProperty(property)) this[property] = data[property];
        }
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $6ca33ce44c416691$export$851d109e5e4aef3d();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $0eddb1afa16352c4$export$33ee60cc95d2cb98 extends (0, $ec0f87cb64500431$export$8f6e4be34af2779b) {
    ...
    processCreateCart(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            let result200 = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = (0, $ca99af87b96f49d8$export$6f32a34769e7c3bf).fromJS(resultData200);
            return result200;
        });
        else if (status === 404) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("The currency is not found.\nor\nThe country is not found.\nor\nThe language is not found.", status, _responseText, _headers);
        });
        else if (status === 403) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("The current user does not have permissions to create a cart.\nor\nThe current user does not have permissions to create a cart to specified user.", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
    ...
    processGetCarts(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            if (Array.isArray(resultData200)) {
                result200 = [];
                for (let item of resultData200)result200.push((0, $6ca33ce44c416691$export$851d109e5e4aef3d).fromJS(item));
            } else result200 = null;
            return result200;
        });
        else if (status === 404) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("No carts found for the user", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
    ...
    processGetCart(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("The cart is not found.", status, _responseText, _headers);
        });
        else if (status === 403) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("The cart is completed.\nor\nThe current user does not have permissions to access this cart.", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
    ...
    processUpdateShipping(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("The cart is not found.\nor\nShipping with the specified id not found.", status, _responseText, _headers);
        });
        else if (status === 403) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("The cart is completed.\nor\nThe current user does not have permissions to access this cart.", status, _responseText, _headers);
        });
...
class $3625b9f230e23319$export$ee448072d182df2e extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $3625b9f230e23319$export$ee448072d182df2e();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $fe21c46cdec9ffba$export$3f4b75158903cae7 extends (0, $da113e3412d10fe0$export$9081fc5a5abbafb5) {
    constructor(data){
        super(data);
    }
    init(_data) {
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $fe21c46cdec9ffba$export$3f4b75158903cae7();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $e9bee94b97fd0115$export$ee2fa6182b3b0170 extends (0, $ec0f87cb64500431$export$8f6e4be34af2779b) {
    ...
    processGetCountries(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            if (Array.isArray(resultData200)) {
                result200 = [];
                for (let item of resultData200)result200.push((0, $3625b9f230e23319$export$ee448072d182df2e).fromJS(item));
            } else result200 = null;
            return result200;
        });
        else if (status === 404) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("No countries found", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
    ...
    processGetCurrencies(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            if (Array.isArray(resultData200)) {
                result200 = [];
                for (let item of resultData200)result200.push((0, $fe21c46cdec9ffba$export$3f4b75158903cae7).fromJS(item));
            } else result200 = null;
            return result200;
        });
        else if (status === 404) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("No currencies found", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
...
class $cdf4f290b8cf9e7c$export$33d379092842afb2 extends (0, $ec0f87cb64500431$export$8f6e4be34af2779b) {
    ...
    processGetOrders(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("The current user does not have permissions to access orders.", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
    ...
    processGetOrder(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("The order is not found.", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
...
class $449d347329659c9d$export$914c60b88733f0a0 extends (0, $ec0f87cb64500431$export$8f6e4be34af2779b) {
    ...
    processGetPayments(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            if (Array.isArray(resultData200)) {
                result200 = [];
                for (let item of resultData200)result200.push((0, $82fdad90cef4c12d$export$721ac1d6252bcdb).fromJS(item));
            } else result200 = null;
            return result200;
        });
        else if (status === 404) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("The language is not found.", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
...
class $6748f101c5ad3cdd$export$c495c97236bab9a2 extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            this.stockLocationAddress = _data["StockLocationAddress"] ? (0, $01fa9bc5f740e732$export$86cdebf7c744b08f).fromJS(_data["StockLocationAddress"]) : undefined;
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $6748f101c5ad3cdd$export$c495c97236bab9a2();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $daa85886ad92d576$export$6e811e2ad18ece64 extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $daa85886ad92d576$export$6e811e2ad18ece64();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $510e323b8e721e5d$export$1a87ce0f97b8b4b9 extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            this.id = _data["Id"];
            this.name = _data["Name"];
            this.image = _data["Image"] ? (0, $daa85886ad92d576$export$6e811e2ad18ece64).fromJS(_data["Image"]) : undefined;
        }
    }
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $510e323b8e721e5d$export$1a87ce0f97b8b4b9();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $1e3891ea72dee86c$export$9efab29e747eddcb extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            this.optionImage = _data["OptionImage"] ? (0, $daa85886ad92d576$export$6e811e2ad18ece64).fromJS(_data["OptionImage"]) : undefined;
            this.image = _data["Image"] ? (0, $daa85886ad92d576$export$6e811e2ad18ece64).fromJS(_data["Image"]) : undefined;
            this.price = _data["Price"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["Price"]) : undefined;
            this.priceMin = _data["PriceMin"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["PriceMin"]) : undefined;
            this.priceMax = _data["PriceMax"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["PriceMax"]) : undefined;
            this.stock = _data["Stock"];
            if (Array.isArray(_data["VariantInfo"])) {
                this.variantInfo = [];
                for (let item of _data["VariantInfo"])this.variantInfo.push($1e3891ea72dee86c$export$9efab29e747eddcb.fromJS(item));
            }
        }
    }
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $1e3891ea72dee86c$export$9efab29e747eddcb();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $9f43444345b17aa6$export$448cb7f028c976c5 extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $9f43444345b17aa6$export$448cb7f028c976c5();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $cb30d68f4d66a0ce$export$1436641fd0c7edb7 extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            this.campaignImage = _data["CampaignImage"] ? (0, $daa85886ad92d576$export$6e811e2ad18ece64).fromJS(_data["CampaignImage"]) : undefined;
        }
    }
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $cb30d68f4d66a0ce$export$1436641fd0c7edb7();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $29c0fa0cfe0965e5$export$143ffe92f84f2111 extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $29c0fa0cfe0965e5$export$143ffe92f84f2111();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $e69031e4b198c0a7$export$d71270591c88ca89 extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            if (_data["Fields"]) {
                this.fields = {};
                for(let key in _data["Fields"])if (_data["Fields"].hasOwnProperty(key)) this.fields[key] = _data["Fields"][key] ? (0, $a0c5af3f7cf64f44$export$4fa50a4986ae6cc1).fromJS(_data["Fields"][key]) : new (0, $a0c5af3f7cf64f44$export$4fa50a4986ae6cc1)();
            }
        }
    }
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $e69031e4b198c0a7$export$d71270591c88ca89();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $72b45c9f9945c3cf$export$23dda9229cb1ccc3 extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $72b45c9f9945c3cf$export$23dda9229cb1ccc3();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $3e6f5c7988c57cf0$export$c93b1a947817bc89 extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["Assets"])) {
                this.assets = [];
                for (let item of _data["Assets"])this.assets.push((0, $daa85886ad92d576$export$6e811e2ad18ece64).fromJS(item));
            }
        }
    }
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $3e6f5c7988c57cf0$export$c93b1a947817bc89();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $5c7c85b319adb698$export$1d5a04157e1500a3 extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["Products"])) {
                this.products = [];
                for (let item of _data["Products"])this.products.push((0, $9f43444345b17aa6$export$448cb7f028c976c5).fromJS(item));
            }
        }
    }
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $5c7c85b319adb698$export$1d5a04157e1500a3();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $7207a019752c445f$export$4705ae49e99a5fff extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            this.replacementProduct = _data["ReplacementProduct"] ? (0, $9f43444345b17aa6$export$448cb7f028c976c5).fromJS(_data["ReplacementProduct"]) : undefined;
            this.price = _data["Price"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["Price"]) : undefined;
            this.priceInformative = _data["PriceInformative"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["PriceInformative"]) : undefined;
            this.priceBeforeDiscount = _data["PriceBeforeDiscount"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["PriceBeforeDiscount"]) : undefined;
            this.discount = _data["Discount"] ? (0, $8bd465f6b80748fc$export$8d3c15329cf77c26).fromJS(_data["Discount"]) : undefined;
            if (Array.isArray(_data["ProductDiscounts"])) {
                this.productDiscounts = [];
                for (let item of _data["ProductDiscounts"])this.productDiscounts.push((0, $cb30d68f4d66a0ce$export$1436641fd0c7edb7).fromJS(item));
            }
            if (Array.isArray(_data["Prices"])) {
                this.prices = [];
                for (let item of _data["Prices"])this.prices.push((0, $29c0fa0cfe0965e5$export$143ffe92f84f2111).fromJS(item));
            }
            if (_data["StandardFields"]) {
                this.standardFields = {};
                for(let key in _data["StandardFields"])if (_data["StandardFields"].hasOwnProperty(key)) this.standardFields[key] = _data["StandardFields"][key] ? (0, $a0c5af3f7cf64f44$export$4fa50a4986ae6cc1).fromJS(_data["StandardFields"][key]) : new (0, $a0c5af3f7cf64f44$export$4fa50a4986ae6cc1)();
            }
            if (_data["ProductFields"]) {
                this.productFields = {};
                for(let key in _data["ProductFields"])if (_data["ProductFields"].hasOwnProperty(key)) this.productFields[key] = _data["ProductFields"][key] ? (0, $a0c5af3f7cf64f44$export$4fa50a4986ae6cc1).fromJS(_data["ProductFields"][key]) : new (0, $a0c5af3f7cf64f44$export$4fa50a4986ae6cc1)();
            }
            if (_data["ProductCategories"]) {
                this.productCategories = {};
                for(let key in _data["ProductCategories"])if (_data["ProductCategories"].hasOwnProperty(key)) this.productCategories[key] = _data["ProductCategories"][key] ? (0, $e69031e4b198c0a7$export$d71270591c88ca89).fromJS(_data["ProductCategories"][key]) : new (0, $e69031e4b198c0a7$export$d71270591c88ca89)();
            }
            if (_data["FieldDisplayGroups"]) {
                this.fieldDisplayGroups = {};
                for(let key in _data["FieldDisplayGroups"])if (_data["FieldDisplayGroups"].hasOwnProperty(key)) this.fieldDisplayGroups[key] = _data["FieldDisplayGroups"][key] ? (0, $e69031e4b198c0a7$export$d71270591c88ca89).fromJS(_data["FieldDisplayGroups"][key]) : new (0, $e69031e4b198c0a7$export$d71270591c88ca89)();
            }
            if (Array.isArray(_data["Groups"])) {
                this.groups = [];
                for (let item of _data["Groups"])this.groups.push((0, $4d62a84edb048ac1$export$314c028c62371730).fromJS(item));
            }
            this.primaryOrDefaultGroup = _data["PrimaryOrDefaultGroup"] ? (0, $4d62a84edb048ac1$export$314c028c62371730).fromJS(_data["PrimaryOrDefaultGroup"]) : undefined;
            this.variantInfo = _data["VariantInfo"] ? (0, $1e3891ea72dee86c$export$9efab29e747eddcb).fromJS(_data["VariantInfo"]) : undefined;
            this.defaultImage = _data["DefaultImage"] ? (0, $daa85886ad92d576$export$6e811e2ad18ece64).fromJS(_data["DefaultImage"]) : undefined;
            ...
            if (Array.isArray(_data["ImagePatternImages"])) {
                ...
                for (let item of _data["ImagePatternImages"])this.imagePatternImages.push((0, $daa85886ad92d576$export$6e811e2ad18ece64).fromJS(item));
            }
            this.manufacturer = _data["Manufacturer"] ? (0, $72b45c9f9945c3cf$export$23dda9229cb1ccc3).fromJS(_data["Manufacturer"]) : undefined;
            if (Array.isArray(_data["AssetCategories"])) {
                this.assetCategories = [];
                for (let item of _data["AssetCategories"])this.assetCategories.push((0, $3e6f5c7988c57cf0$export$c93b1a947817bc89).fromJS(item));
            }
            this.neverOutOfstock = _data["NeverOutOfstock"];
            if (Array.isArray(_data["StockUnits"])) {
                this.stockUnits = [];
                for (let item of _data["StockUnits"])this.stockUnits.push((0, $6748f101c5ad3cdd$export$c495c97236bab9a2).fromJS(item));
            }
            if (Array.isArray(_data["UnitOptions"])) {
                this.unitOptions = [];
                for (let item of _data["UnitOptions"])this.unitOptions.push((0, $510e323b8e721e5d$export$1a87ce0f97b8b4b9).fromJS(item));
            }
            if (Array.isArray(_data["RelatedGroups"])) {
                this.relatedGroups = [];
                for (let item of _data["RelatedGroups"])this.relatedGroups.push((0, $5c7c85b319adb698$export$1d5a04157e1500a3).fromJS(item));
            }
        }
    }
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $7207a019752c445f$export$4705ae49e99a5fff();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $4f45c9bc66246d8d$export$c2e82715bf48e18f extends (0, $4d62a84edb048ac1$export$314c028c62371730) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["GroupFields"])) {
                this.groupFields = [];
                for (let item of _data["GroupFields"])this.groupFields.push((0, $a0c5af3f7cf64f44$export$4fa50a4986ae6cc1).fromJS(item));
            }
            if (Array.isArray(_data["Assets"])) {
                this.assets = [];
                for (let item of _data["Assets"])this.assets.push((0, $daa85886ad92d576$export$6e811e2ad18ece64).fromJS(item));
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $4f45c9bc66246d8d$export$c2e82715bf48e18f();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $76090f7c6c7f002c$export$bc672b9cbce29635 extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $76090f7c6c7f002c$export$bc672b9cbce29635();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $5094c171d29cfd26$export$d12ee91cd036f400 extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["Options"])) {
                this.options = [];
                for (let item of _data["Options"])this.options.push((0, $76090f7c6c7f002c$export$bc672b9cbce29635).fromJS(item));
            }
    ...
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $5094c171d29cfd26$export$d12ee91cd036f400();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $f3e54e8534645a35$export$fdf398ed99472cfe extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["Facets"])) {
                this.facets = [];
                for (let item of _data["Facets"])this.facets.push((0, $5094c171d29cfd26$export$d12ee91cd036f400).fromJS(item));
            }
        }
    }
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $f3e54e8534645a35$export$fdf398ed99472cfe();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $f0e4d5a7d301f023$export$c23b750e5a0f6dff extends (0, $da113e3412d10fe0$export$56d724b3d6ab4309) {
    constructor(data){
        super(data);
    }
    init(_data) {
        super.init(_data);
        if (_data) {
            this.group = _data["Group"] ? (0, $4f45c9bc66246d8d$export$c2e82715bf48e18f).fromJS(_data["Group"]) : undefined;
            if (Array.isArray(_data["SubGroups"])) {
                this.subGroups = [];
                for (let item of _data["SubGroups"])this.subGroups.push((0, $4f45c9bc66246d8d$export$c2e82715bf48e18f).fromJS(item));
            }
            if (Array.isArray(_data["Products"])) {
                this.products = [];
                for (let item of _data["Products"])this.products.push((0, $7207a019752c445f$export$4705ae49e99a5fff).fromJS(item));
            }
            ...
            if (Array.isArray(_data["FacetGroups"])) {
                this.facetGroups = [];
                for (let item of _data["FacetGroups"])this.facetGroups.push((0, $f3e54e8534645a35$export$fdf398ed99472cfe).fromJS(item));
            }
        }
    }
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
        let result = new $f0e4d5a7d301f023$export$c23b750e5a0f6dff();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class $c21a0ae564900c1e$export$c7599661db785dae extends (0, $ec0f87cb64500431$export$8f6e4be34af2779b) {
    ...
    processGetAll(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            let result200 = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = (0, $f0e4d5a7d301f023$export$c23b750e5a0f6dff).fromJS(resultData200);
            return result200;
        });
        else if (status === 404) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("No matching products found", status, _responseText, _headers);
        });
        else if (status === 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("No products match the parameters", status, _responseText, _headers);
        });
        else if (status === 400) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("Invalid parameters. Specify Repository and Queryname or specify a group id", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
    ...
    processGetProduct(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            let result200 = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = (0, $7207a019752c445f$export$4705ae49e99a5fff).fromJS(resultData200);
            return result200;
        });
        else if (status === 404) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("No matching product found", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
    ...
    processRelated(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("No matching related products found", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
    ...
    processExportProducts(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("Invalid parameters. Missing required parameters.", status, _responseText, _headers);
        });
        else if (status === 402) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("You don't have a proper license to support this feature", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
...
class $e047f322d2b943a4$export$22ecf64bbb48d645 extends (0, $ec0f87cb64500431$export$8f6e4be34af2779b) {
    ...
    processGetShippings(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            ...
            if (Array.isArray(resultData200)) {
                result200 = [];
                for (let item of resultData200)result200.push((0, $cdca1f42c0609789$export$eed10c966122c057).fromJS(item));
            } else result200 = null;
            return result200;
        });
        else if (status === 400) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("A language id must be specified", status, _responseText, _headers);
        });
        else if (status !== 200 && status !== 204) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("An unexpected server error occurred.", status, _responseText, _headers);
        });
...
class $d5502a069d5e178f$export$ff39e19587dd8c73 extends (0, $ec0f87cb64500431$export$8f6e4be34af2779b) {
    ...
    processGetVariantInfo(response) {
        ...
        if (status === 200) return response.text().then((_responseText)=>{
            let result200 = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = (0, $1e3891ea72dee86c$export$9efab29e747eddcb).fromJS(resultData200);
            return result200;
        });
        else if (status === 404) return response.text().then((_responseText)=>{
            return (0, $29b57722f486c5a3$export$de0c4a986b439e52)("No matching product found", status, _responseText, _headers);
...
var $03a5f86ae696fb5e$export$2e2bcd8739ae039 = {
    CartsClient: $0eddb1afa16352c4$export$33ee60cc95d2cb98,
    FeedClient: $b53827fce66ab065$export$a7828f465fa73b14,
    GroupsClient: $fa77f7abbf780bca$export$f40d29ef16d78592,
    InternationalClient: $e9bee94b97fd0115$export$ee2fa6182b3b0170,
    OrderClient: $cdf4f290b8cf9e7c$export$33d379092842afb2,
    PaymentsClient: $449d347329659c9d$export$914c60b88733f0a0,
    ProductsClient: $c21a0ae564900c1e$export$c7599661db785dae,
    ShippingClient: $e047f322d2b943a4$export$22ecf64bbb48d645,
    VariantsClient: $d5502a069d5e178f$export$ff39e19587dd8c73
};




export {$c04bd6215bd9ff9b$export$2e2bcd8739ae039 as Authentication, $e3157da9779f0eea$export$2e2bcd8739ae039 as Content, $03a5f86ae696fb5e$export$2e2bcd8739ae039 as Ecommerce};
